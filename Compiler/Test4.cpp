...
extern refalrts::FnResult CreateIdent(refalrts::Iter arg_begin, refalrts::Iter arg_end);

extern refalrts::FnResult WriteLine(refalrts::Iter arg_begin, refalrts::Iter arg_end);

static refalrts::FnResult TestIdent(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  do {
    ...
    // # Ident2
    if( ! refalrts::ident_left(  & Ident2<int>::name, bb_0, be_0 ) ) 
      break;
...
static refalrts::FnResult Tag1(refalrts::Iter, refalrts::Iter) {
  return refalrts::cRecognitionImpossible;
}

static refalrts::FnResult Tag2(refalrts::Iter, refalrts::Iter) {
  return refalrts::cRecognitionImpossible;
}

static refalrts::FnResult DoTestADT(refalrts::Iter arg_begin, refalrts::Iter arg_end);

static refalrts::FnResult TestADT(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  do {
    refalrts::Iter bb_0 = arg_begin;
    refalrts::Iter be_0 = arg_end;
    refalrts::move_left( bb_0, be_0 );
    ...
    if( ! refalrts::alloc_open_call( n0 ) )
      return refalrts::cNoMemory;
    refalrts::Iter n1 = 0;
    if( ! refalrts::alloc_name( n1, & DoTestADT, "DoTestADT" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n2 = 0;
    if( ! refalrts::alloc_open_adt( n2 ) )
      return refalrts::cNoMemory;
    refalrts::Iter n3 = 0;
    if( ! refalrts::alloc_name( n3, & Tag1, "Tag1" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n4 = 0;
    ...
    if( ! refalrts::alloc_open_adt( n13 ) )
      return refalrts::cNoMemory;
    refalrts::Iter n14 = 0;
    if( ! refalrts::alloc_name( n14, & Tag2, "Tag2" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n15 = 0;
...
static refalrts::FnResult DoTestADT(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  do {
    ...
    refalrts::move_left( bb_0, be_0 );
    refalrts::move_right( bb_0, be_0 );
    refalrts::Iter e1_b_1;
    refalrts::Iter e1_e_1;
    refalrts::Iter e2_b_1;
    refalrts::Iter e2_e_1;
    refalrts::Iter sNext_1;
    refalrts::Iter sLast_1;
    refalrts::Iter eInner_b_1;
    refalrts::Iter eInner_e_1;
    // [~1 & Tag1 e.1 ]~1 s.Next e.Inner s.Last [~2 & Tag2 e.2 ]~2
    refalrts::Iter bb_1 = 0;
    refalrts::Iter be_1 = 0;
    if( ! refalrts::adt_left( bb_1, be_1, & Tag1, bb_0, be_0 ) ) 
      break;
    refalrts::Iter bb_2 = 0;
    refalrts::Iter be_2 = 0;
    if( ! refalrts::adt_right( bb_2, be_2, & Tag2, bb_0, be_0 ) ) 
      break;
    e1_b_1 = bb_1;
    refalrts::use( e1_b_1 );
    e1_e_1 = be_1;
    ...
    if( ! refalrts::alloc_close_adt( n4 ) )
      return refalrts::cNoMemory;
    refalrts::Iter n5 = 0;
    if( ! refalrts::alloc_open_adt( n5 ) )
      return refalrts::cNoMemory;
    refalrts::Iter n6 = 0;
    if( ! refalrts::alloc_name( n6, & Tag2, "Tag2" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n7 = 0;
  ...
  do {
    ...
    refalrts::Iter bb_2 = 0;
    refalrts::Iter be_2 = 0;
    if( ! refalrts::adt_left( bb_2, be_2, & Tag2, bb_0, be_0 ) ) 
      break;
    if( ! empty_seq( bb_0, be_0 ) )
      break;
    e1_b_1 = bb_1;
...
static refalrts::FnResult TestDump(refalrts::Iter, refalrts::Iter) {
  return refalrts::cRecognitionImpossible;
}

extern refalrts::FnResult SymbCompare(refalrts::Iter arg_begin, refalrts::Iter arg_end);

static refalrts::FnResult TestOrder(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  do {
    refalrts::Iter bb_0 = arg_begin;
    refalrts::Iter be_0 = arg_end;
    refalrts::move_left( bb_0, be_0 );
    ...
    if( ! refalrts::alloc_name( n3, & SymbCompare, "SymbCompare" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n4 = 0;
    if( ! refalrts::alloc_ident( n4, & Ident2<int>::name ) )
      return refalrts::cNoMemory;
    refalrts::Iter n5 = 0;
    if( ! refalrts::alloc_name( n5, & TestDump, "TestDump" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n6 = 0;
...
refalrts::FnResult Go(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  do {
    ...
    if( ! refalrts::alloc_open_call( n0 ) )
      return refalrts::cNoMemory;
    refalrts::Iter n1 = 0;
    if( ! refalrts::alloc_name( n1, & TestIdent, "TestIdent" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n2 = 0;
    if( ! refalrts::alloc_open_call( n2 ) )
      return refalrts::cNoMemory;
    refalrts::Iter n3 = 0;
    if( ! refalrts::alloc_name( n3, & CreateIdent, "CreateIdent" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n4 = 0;
    ...
    if( ! refalrts::alloc_open_call( n6 ) )
      return refalrts::cNoMemory;
    refalrts::Iter n7 = 0;
    if( ! refalrts::alloc_name( n7, & TestADT, "TestADT" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n8 = 0;
    if( ! refalrts::alloc_close_call( n8 ) )
      return refalrts::cNoMemory;
    ...
    if( ! refalrts::alloc_char( n21, ' ' ) )
      return refalrts::cNoMemory;
    refalrts::Iter n22 = 0;
    if( ! refalrts::alloc_ident( n22, & Ident2<int>::name ) )
      return refalrts::cNoMemory;
    refalrts::Iter n23 = 0;
    if( ! refalrts::alloc_open_adt( n23 ) )
      return refalrts::cNoMemory;
    refalrts::Iter n24 = 0;
    if( ! refalrts::alloc_name( n24, & Tag1, "Tag1" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n25 = 0;
    if( ! refalrts::alloc_open_adt( n25 ) )
      return refalrts::cNoMemory;
    refalrts::Iter n26 = 0;
    if( ! refalrts::alloc_name( n26, & Tag2, "Tag2" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n27 = 0;
    if( ! refalrts::alloc_ident( n27, & Ident2<int>::name ) )
      return refalrts::cNoMemory;
    refalrts::Iter n28 = 0;
    if( ! refalrts::alloc_close_adt( n28 ) )
      return refalrts::cNoMemory;
    refalrts::Iter n29 = 0;
    if( ! refalrts::alloc_close_adt( n29 ) )
      return refalrts::cNoMemory;
    refalrts::Iter n30 = 0;
    ...
    if( ! refalrts::alloc_open_call( n31 ) )
      return refalrts::cNoMemory;
    refalrts::Iter n32 = 0;
    if( ! refalrts::alloc_name( n32, & TestOrder, "TestOrder" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n33 = 0;
