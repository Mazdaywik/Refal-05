...
refalrts::FnResult ParseCommandLine(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    static refalrts::ResultAction raa[] = {
      ...
      {refalrts::icFunc, & DoParseCommandLine, "DoParseCommandLine"},
...
static refalrts::FnResult DoParseCommandLine(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    static refalrts::ResultAction raa[] = {
      {refalrts::icBracket, 0, 0, refalrts::ibOpenCall},
      {refalrts::icFunc, & DoParseFileNames, "DoParseFileNames"},
      {refalrts::icBracket, 0, 0, refalrts::ibOpenBracket},
      {refalrts::icFunc, & CompileCommand, "CompileCommand"},
  ...
  do {
    ...
    static refalrts::ResultAction raa[] = {
      {refalrts::icBracket, 0, 0, refalrts::ibOpenBracket},
      {refalrts::icFunc, & CmdLineError, "CmdLineError"},
  ...
  do {
    ...
    static refalrts::ResultAction raa[] = {
      {refalrts::icBracket, 0, 0, refalrts::ibOpenCall},
      {refalrts::icFunc, & DoParseFileNamesOnly, "DoParseFileNamesOnly"},
      {refalrts::icBracket, 0, 0, refalrts::ibOpenBracket},
      {refalrts::icFunc, & NoCompile, "NoCompile"},
      {refalrts::icBracket, 0, 0, refalrts::ibCloseBracket},
      {refalrts::icBracket, 0, 0, refalrts::ibOpenBracket},
      {refalrts::icSpliceEVar, & eScannedFiles_b_1, & eScannedFiles_e_1},
      {refalrts::icBracket, 0, 0, refalrts::ibCloseBracket},
