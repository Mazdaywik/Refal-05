...
static refalrts::FnResult lambda_EscapeChar_0(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    const static refalrts::ResultAction raa[] = {
      ...
      {refalrts::icSpliceSTVar, & sCode_2_1},
      ...
      {refalrts::icBracket, 0, 0, refalrts::ibOpenCall},
      {refalrts::icFunc, (void*) & Div, (void*) "Div"},
      {refalrts::icCopySTVar, & sCode_2_1},
    ...
    refalrts::reset_allocator();
    refalrts::Iter res = arg_begin;
    if( ! refalrts::copy_stvar( sCode_2_2, sCode_2_1 ) )
      return refalrts::cNoMemory;
    if( ! refalrts::copy_stvar( sCode_2_3, sCode_2_2 ) )
      return refalrts::cNoMemory;
    refalrts::Iter n0 = 0;
    ...
    res = refalrts::splice_stvar( res, sCode_2_3 );
    ...
    res = refalrts::splice_stvar( res, sCode_2_2 );
    ...
    res = refalrts::splice_stvar( res, sCode_2_1 );
  ...
  do {
    ...
    if( ! refalrts::svar_left( sOther_1_1, bb_0, be_0 ) )
      break;
    if( ! refalrts::svar_left( sCompare_2_1, bb_0, be_0 ) )
      break;
    if( ! refalrts::svar_left( sCode_2_1, bb_0, be_0 ) )
      break;
    if( ! refalrts::empty_seq( bb_0, be_0 ) )
...
refalrts::FnResult EscapeChar(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    const static refalrts::ResultAction raa[] = {
      ...
      {refalrts::icCopySTVar, & sOther_1_1},
      {refalrts::icBracket, 0, 0, refalrts::ibCloseCall},
      {refalrts::icBracket, 0, 0, refalrts::ibOpenCall},
    ...
    refalrts::reset_allocator();
    refalrts::Iter res = arg_begin;
    if( ! refalrts::copy_stvar( sOther_1_2, sOther_1_1 ) )
      return refalrts::cNoMemory;
    if( ! refalrts::copy_stvar( sOther_1_3, sOther_1_2 ) )
      return refalrts::cNoMemory;
    refalrts::Iter n0 = 0;
    ...
    res = refalrts::splice_elem( res, n12 );
    res = refalrts::splice_stvar( res, sOther_1_3 );
    res = refalrts::splice_elem( res, n11 );
    res = refalrts::splice_elem( res, n10 );
    res = refalrts::splice_elem( res, n9 );
    refalrts::push_stack( n8 );
    refalrts::push_stack( n6 );
    res = refalrts::splice_elem( res, n8 );
    res = refalrts::splice_stvar( res, sOther_1_2 );
    res = refalrts::splice_elem( res, n7 );
    res = refalrts::splice_elem( res, n6 );
