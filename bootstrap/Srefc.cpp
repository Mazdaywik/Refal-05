...
static refalrts::FnResult Compile_And_Link(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::Iter eFiles_E_b_1;
    refalrts::Iter eFiles_E_e_1;
    refalrts::Iter tCompiler_1;
    refalrts::Iter eFiles_B_b_1;
    refalrts::Iter eFiles_B_e_1;
...
static refalrts::FnResult CompileEachFile(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::Iter eOutput_b_1;
    refalrts::Iter eOutput_e_1;
    refalrts::Iter eSource_b_2;
    refalrts::Iter eSource_e_2;
    // (~1 &Source (~2 e.Source )~2 e.Output )~1
    refalrts::Iter bb_1 = 0;
    refalrts::Iter be_1 = 0;
    if( ! refalrts::brackets_left( bb_1, be_1, bb_0, be_0 ) ) 
...
static refalrts::FnResult Link(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::Iter eOutputs_B_b_1;
    refalrts::Iter eOutputs_B_e_1;
    refalrts::Iter eOutputs_E_b_1;
    refalrts::Iter eOutputs_E_e_1;
  ...
  do {
    ...
    refalrts::Iter eCommand_b_1;
    refalrts::Iter eCommand_e_1;
    refalrts::Iter eOutputs_b_1;
    refalrts::Iter eOutputs_e_1;
