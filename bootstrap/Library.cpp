...
extern enum r05_fnresult r05c_r(struct r05_node *arg_begin, struct r05_node *arg_end);
extern enum r05_fnresult r05c_w(struct r05_node *arg_begin, struct r05_node *arg_end);
extern enum r05_fnresult r05c_a(struct r05_node *arg_begin, struct r05_node *arg_end);
extern enum r05_fnresult r05c_rb(struct r05_node *arg_begin, struct r05_node *arg_end);
extern enum r05_fnresult r05c_wb(struct r05_node *arg_begin, struct r05_node *arg_end);
extern enum r05_fnresult r05c_ab(struct r05_node *arg_begin, struct r05_node *arg_end);
...
#include <stdlib.h>
#include <string.h>
#line 84 "..\\lib/Library.cpp"
enum r05_fnresult r05c_Mu(struct r05_node *arg_begin, struct r05_node *arg_end) {
  r05_this_is_generated_function();
  do {
    struct r05_node *sFunc_1;
    ...
    /* s.Func e.Arg */
    if (! r05_svar_left(&sFunc_1, &bb[0], &be[0]))
      break;
    eArg_b_1 = bb[0];
    eArg_e_1 = be[0];
...
#line 103 "..\\lib/Library.ref"
static void read_from_stream(FILE *input);
#line 195 "..\\lib/Library.cpp"
enum r05_fnresult r05c_Card(struct r05_node *arg_begin, struct r05_node *arg_end) {
#line 108 "..\\lib/Library.ref"
  ...
  return R05_SUCCESS;
#line 210 "..\\lib/Library.cpp"
  /* return R05_RECOGNITION_IMPOSSIBLE; */
}

#line 125 "..\\lib/Library.ref"
static void read_from_stream(FILE *input) {
  int cur_char;
...
#line 180 "..\\lib/Library.ref"
  ARITHM_OP(/, CHECK_ZERODIV);
#line 269 "..\\lib/Library.cpp"
  /* return R05_RECOGNITION_IMPOSSIBLE; */
}

enum r05_fnresult r05c_Divmod(struct r05_node *arg_begin, struct r05_node *arg_end) {
  r05_this_is_generated_function();
  do {
    struct r05_node *sX_1;
    struct r05_node *sY_1;
    struct r05_node *bb[1] = { 0 };
    struct r05_node *be[1] = { 0 };
    ...
    r05_prepare_argument(&bb[0], &be[0], arg_begin, arg_end);
    /* s.X s.Y */
    if (! r05_svar_left(&sX_1, &bb[0], &be[0]))
      break;
    if (! r05_svar_left(&sY_1, &bb[0], &be[0]))
      break;
...
#line 229 "..\\lib/Library.ref"
FILE *open_numbered(unsigned int no, const char mode);
#line 347 "..\\lib/Library.cpp"
enum r05_fnresult r05c_Get(struct r05_node *arg_begin, struct r05_node *arg_end) {
#line 234 "..\\lib/Library.ref"
  struct r05_node *callable = arg_begin->next;
  ...
  return R05_SUCCESS;
#line 370 "..\\lib/Library.cpp"
  /* return R05_RECOGNITION_IMPOSSIBLE; */
}

#line 259 "..\\lib/Library.ref"
enum { FILE_LIMIT = 40 };
...
enum r05_fnresult r05c_Lower(struct r05_node *arg_begin, struct r05_node *arg_end) {
#line 314 "..\\lib/Library.ref"
  struct r05_node *callee = arg_begin->next;
  struct r05_node *p = callee->next;
  ...
  return R05_SUCCESS;
#line 445 "..\\lib/Library.cpp"
  /* return R05_RECOGNITION_IMPOSSIBLE; */
}

enum r05_fnresult r05c_Mod(struct r05_node *arg_begin, struct r05_node *arg_end) {
#line 337 "..\\lib/Library.ref"
  ARITHM_OP(%, CHECK_ZERODIV);
#line 452 "..\\lib/Library.cpp"
  /* return R05_RECOGNITION_IMPOSSIBLE; */
}

enum r05_fnresult r05c_Mul(struct r05_node *arg_begin, struct r05_node *arg_end) {
#line 347 "..\\lib/Library.ref"
  ARITHM_OP(*, NO_CHECK)
#line 459 "..\\lib/Library.cpp"
  /* return R05_RECOGNITION_IMPOSSIBLE; */
}

enum r05_fnresult r05c_Numb(struct r05_node *arg_begin, struct r05_node *arg_end) {
#line 361 "..\\lib/Library.ref"
  struct r05_node *callee = arg_begin->next;
  struct r05_node *p;
  r05_number result = 0;
  ...
  return R05_SUCCESS;
#line 483 "..\\lib/Library.cpp"
  /* return R05_RECOGNITION_IMPOSSIBLE; */
}

enum r05_fnresult r05c_r(struct r05_node *, struct r05_node *) {
  return (enum r05_fnresult)(
    R05_RECOGNITION_IMPOSSIBLE | (__LINE__ << 8)
  );
}

enum r05_fnresult r05c_w(struct r05_node *, struct r05_node *) {
  return (enum r05_fnresult)(
    R05_RECOGNITION_IMPOSSIBLE | (__LINE__ << 8)
  );
}

enum r05_fnresult r05c_a(struct r05_node *, struct r05_node *) {
  return (enum r05_fnresult)(
    R05_RECOGNITION_IMPOSSIBLE | (__LINE__ << 8)
  );
}

enum r05_fnresult r05c_rb(struct r05_node *, struct r05_node *) {
  return (enum r05_fnresult)(
    R05_RECOGNITION_IMPOSSIBLE | (__LINE__ << 8)
  );
}

enum r05_fnresult r05c_wb(struct r05_node *, struct r05_node *) {
  return (enum r05_fnresult)(
    R05_RECOGNITION_IMPOSSIBLE | (__LINE__ << 8)
  );
}

enum r05_fnresult r05c_ab(struct r05_node *, struct r05_node *) {
  return (enum r05_fnresult)(
    R05_RECOGNITION_IMPOSSIBLE | (__LINE__ << 8)
  );
}

#line 393 "..\\lib/Library.ref"
static void ensure_close_stream(unsigned int file_no);
#line 525 "..\\lib/Library.cpp"
enum r05_fnresult r05c_Open(struct r05_node *arg_begin, struct r05_node *arg_end) {
#line 398 "..\\lib/Library.ref"
  ...
  return R05_SUCCESS;
#line 597 "..\\lib/Library.cpp"
  /* return R05_RECOGNITION_IMPOSSIBLE; */
}

#line 471 "..\\lib/Library.ref"
static void ensure_close_stream(unsigned int file_no) {
...
#line 641 "..\\lib/Library.cpp"
enum r05_fnresult r05c_Print(struct r05_node *arg_begin, struct r05_node *arg_end) {
#line 524 "..\\lib/Library.ref"
  return output_func(arg_begin, arg_end, PRINT);
#line 645 "..\\lib/Library.cpp"
  /* return R05_RECOGNITION_IMPOSSIBLE; */
}

#line 529 "..\\lib/Library.ref"
static enum r05_fnresult output_func(
  struct r05_node *arg_begin, struct r05_node *arg_end,
  enum output_func_type type
) {
...
#line 721 "..\\lib/Library.cpp"
enum r05_fnresult r05c_Prout(struct r05_node *arg_begin, struct r05_node *arg_end) {
#line 608 "..\\lib/Library.ref"
  return output_func(arg_begin, arg_end, PROUT);
#line 725 "..\\lib/Library.cpp"
  /* return R05_RECOGNITION_IMPOSSIBLE; */
}

enum r05_fnresult r05c_Put(struct r05_node *arg_begin, struct r05_node *arg_end) {
#line 618 "..\\lib/Library.ref"
  return output_func(arg_begin, arg_end, PUT);
#line 732 "..\\lib/Library.cpp"
  /* return R05_RECOGNITION_IMPOSSIBLE; */
}

enum r05_fnresult r05c_Putout(struct r05_node *arg_begin, struct r05_node *arg_end) {
#line 628 "..\\lib/Library.ref"
  return output_func(arg_begin, arg_end, PUTOUT);
#line 739 "..\\lib/Library.cpp"
  /* return R05_RECOGNITION_IMPOSSIBLE; */
}
...
#line 645 "..\\lib/Library.ref"
  ARITHM_OP(-, NO_CHECK)
#line 758 "..\\lib/Library.cpp"
  /* return R05_RECOGNITION_IMPOSSIBLE; */
}

enum r05_fnresult r05c_Symb(struct r05_node *arg_begin, struct r05_node *arg_end) {
#line 655 "..\\lib/Library.ref"
  struct r05_node *callable = arg_begin->next;
...
enum r05_fnresult r05c_ListOfBuiltin(struct r05_node *arg_begin, struct r05_node *arg_end) {
  ...
  do {
    ...
    r05_alloc_open_bracket(n[122]);
    r05_alloc_number(71UL);
    r05_alloc_function(r05c_GetPPID, "GetPPID");
    r05_alloc_function(r05c_regular, "regular");
    r05_alloc_close_bracket(n[123]);
    r05_link_brackets(n[122], n[123]);
