...
2³² («макроцифры»). Если первое слагаемое содержит ровно одну макроцифру,
то вокруг него скобки ставить необязательно.
...
* Если используется Рефал-5 скомпилированный на платформе Linux x64 или macOS,
  следует избегать длинной арифметики и литер чисел, больших 2³² — в нём
  макроцифры 64-разрядные.
