...
_Примечание._ Компилятор Рефала-05 требует, чтобы все локальные функции
...
_Примечание._ Можно объявить пустую entry-функцию и без ключевого слова
`$EENUM`, вот так:
...
_Примечание._ Поиск среди entry-функций не документирован в учебнике Турчина,
...
_Примечание._ Косвенный вызов в Рефале-5 может осуществляться также функциями
